...
def main():
    ...
    geneLengthDict = parseGeneLengthDict("D:/Dropbox (XinghuaLu)/Shared_group/TSDM/TCI/Tumor.Type.Data/Gene.Exome.Length.csv")
    ...
    mutMatrixFilePath = "D:/Dropbox (XinghuaLu)/Shared_group/TSDM/TCI/Tumor.Type.Data/BRCA/BRCA.GtM.csv"
    degMatrixFilePath =  "D:/Dropbox (XinghuaLu)/Shared_group/TSDM/TCI/Tumor.Type.Data/BRCA/BRCA.GeM.csv"
    outputFilePath =  "D:/Dropbox (XinghuaLu)/Shared_group/TSDM/TCI/Tumor.Type.Data/BRCA/CombLogicAND.Results"
...
#    outputFilePath = "/home/kevin/GroupDropbox/TCI/Tumor.Type.Data/BLCA/TestLogicalAnd"
    ...
    #Calculate TCI Score by calling calcTCI with the following arguments:
    #mutation matrix, DEG matrix, output filepath, gene length dictionary, and an optional operation flag
    calcTCI(mutcnaMatrixFN=mutMatrixFilePath, degMatrixFN=degMatrixFilePath, outputPath = outputFilePath,  dictGeneLength = geneLengthDict, opFlag = "AND")
